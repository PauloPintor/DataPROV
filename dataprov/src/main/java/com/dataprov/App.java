...
public class App 
{
    public static void main( String[] args ) throws Exception
    {
		...
		if(printHelp){
			...
			AppManager app = new AppManager(database, databaseURL, query, withWhy, withBoolean, withTrio, withPos, withLineage, withTrasnform, withTime, noProvenance, noResult, withBdInfo);
		}
    }
