...
public class AppManager {
    ...
    public AppManager(String database, String databaseURL, String query, boolean withWhy, boolean withBoolean, boolean withTrio, boolean withPos, boolean withLineage, boolean withTrasnform, boolean withTime, boolean noProvenance, boolean noResult, boolean withTbInfo, boolean originalResult) throws Exception {
    ...
    public String parseQuery() throws Exception{
        Parser parser = new Parser(database, withTbInfo, originalResult);
		long startTime = 0;
		long endTime = 0;
    ...
    private void printResult(ResultSet result) throws SQLException, IOException{
		...
		if (withTime && (withWhy || withBoolean || withTrio || withPos || withLineage)) {
			startTime = System.currentTimeMillis();
		}
        ResultProcess rp = new ResultProcess(withWhy, withBoolean, withTrio, withPos, withLineage);
	...
	public void setWithBoolean(boolean withBoolean) {
		this.withBoolean = withBoolean;
	}

	public void setWithTrio(boolean withTrio) {
		this.withTrio = withTrio;
	}

	public void setWithPos(boolean withPos) {
		this.withPos = withPos;
	}

	public void setWithLineage(boolean withLineage) {
		this.withLineage = withLineage;
	}
